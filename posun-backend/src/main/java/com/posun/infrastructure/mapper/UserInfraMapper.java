...
public class UserInfraMapper {
    ...
    public static UserModel toModel(UserEntity userEntity, Tenant tenant) {

        if (userEntity == null) {
            return null;
        }
        if (userEntity instanceof UserAdminEntity adminEntity) {
            return UserAdminInfraMapper.toModel(adminEntity, tenant);
        }
        if (userEntity instanceof UserClientEntity clientEntity){
            return UserClientInfraMapper.toModel(clientEntity, tenant);
        }
